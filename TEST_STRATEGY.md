...
# Default: botnet.floppydicks.net:1883
...
|---------|----------|---------|----------|
| MQTT Broker | Optional | Validate real MQTT connections | `botnet.floppydicks.net:1883` |
| Nova/Great Library | Optional | Test real evidence validation | `http://100.73.200.19:30850` |
