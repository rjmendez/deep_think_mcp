...
Environment variables:
  MQTT_HOST              MQTT broker hostname (default: botnet.floppydicks.net)
  MQTT_PORT              MQTT broker port (default: 1883)
  MQTT_USERNAME          MQTT username (default: dama)
  MQTT_PASSWORD          MQTT password (required)
  NOVA_URL               Nova endpoint (default: http://100.73.200.19:30850)
  OLLAMA_URL             Ollama endpoint (default: http://100.73.200.19:11434)
...
def main():
    ...
    nova_url = os.getenv("NOVA_URL", "http://100.73.200.19:30850")
    ollama_url = os.getenv("OLLAMA_URL", "http://100.73.200.19:11434")
