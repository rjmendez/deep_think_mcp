...
- [ ] NOVA_TOKEN is valid and not expired: Test with `curl -H "Authorization: Bearer $NOVA_TOKEN" http://100.73.200.19:30850/health`
...
curl -vI https://100.73.200.19:30850/health
