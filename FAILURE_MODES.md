...
2. **Manual intervention:**
   - Verify Nova service health: `curl -H "Authorization: Bearer $NOVA_TOKEN" http://100.73.200.19:30850/health`
   ...
   - Verify network connectivity: `ping 100.73.200.19`
   - Validate credentials: Ensure NOVA_TOKEN and NOVA_TOTP_SEED are correct
   - Check TLS certificate: `openssl s_client -connect 100.73.200.19:30850 -showcerts`
