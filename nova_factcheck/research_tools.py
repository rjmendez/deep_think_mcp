...
Environment variables:
    NOVA_BASE_URL          Nova service base URL (default: http://100.73.200.19:30850)
    ...
    DAMA_BASE_URL          DAMA API base URL (default: http://100.73.200.19:30900)
...
DAMA_BASE_URL = os.getenv("DAMA_BASE_URL", "http://100.73.200.19:30900").rstrip("/")
