...
curl -H "Authorization: Bearer $NOVA_TOKEN" \
     ...
     http://100.73.200.19:30850/health
...
curl http://100.73.200.19:30850/health
...
time curl -s http://100.73.200.19:30850/health >/dev/null

# Check Nova metrics
curl http://100.73.200.19:30850/metrics | grep nova_latency
```
...
```bash
ping 100.73.200.19  # Nova
ping $MQTT_BROKER_HOST  # MQTT broker

# Check packet loss
ping -c 100 100.73.200.19 | grep "% packet loss"
