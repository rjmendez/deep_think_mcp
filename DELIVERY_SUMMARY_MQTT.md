...
**Location:** `/home/USER/development/deep_think_mcp/mqtt_integration.py`
...
**Location:** `/home/USER/development/deep_think_mcp/.env`
...
MQTT_PASSWORD=[REDACTED_MQTT_PASSWORD]   # Authentication password (secret)
...
**Location:** `/home/USER/development/deep_think_mcp/tests/test_mqtt_integration_new.py`
...
```
┌─────────────────────────────────────────────────────────────────┐
│ MQTT Broker: [REDACTED_MQTT_HOST]:1883                        │
...
```
[MQTT] Initialized processor: MQTTConfig(host=[REDACTED_MQTT_HOST]:1883, ...)
