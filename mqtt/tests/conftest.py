"""Pytest configuration and fixtures for MQTT tests.

This conftest.py provides shared fixtures for all MQTT test modules.
It's automatically discovered and loaded by pytest.
"""
